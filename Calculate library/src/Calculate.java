...
public class Calculate {
	 ...
	 */
	  average (double operand1, double operand2 ) { return ((operand1+
	  operand2)/2); } /*this method does the same as average but returns with three
	  doubles
	 
public static double average2 (double operand1, operand2, operand3) {
